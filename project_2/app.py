...
def insert_to_db(list_currencies):
    client = MongoClient("mongodb://pinhao:<PASSWORD>@cluster0-shard-00-00-lqten.mongodb.net:27017,cluster0-shard-00-01-lqten.mongodb.net:27017,cluster0-shard-00-02-lqten.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority")
